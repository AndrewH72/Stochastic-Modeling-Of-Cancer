# RUN X AMOUNT OF SIMULATIONS TO SEE THE AVERAGE TIME THAT POPULATION B FIRST APPEARS AND THE MAX SIZE OF EACH
# MAX SIZE OF RESISTANT POPULATION
# IMPLEMENT CYCLIC TREATMENT
# PLAY AROUND WITH DRUG RATIO, CYCLE TIMES
# MAYBE LOOK AT TUMOR HETEROGENEITY AFTERWARDS (PLAY AROUND WITH POPULATIONS)
# MAKE IMPLEMENTATION MORE EFFICIENT (PYTHON, FRAMEWORK)
# TURNOVER CANCER TYPES
...
drugInducedDeathRate1 = 0
drugInducedDeathRate2 = 0
...
write.csv(tumorData, file=paste("/Users/andrewhsu/Projects/PREP-NURA/NURA/data/RevisedModel/tumorLog.sampleSize_", sampleSize, ".birthRate_", birthRate, ".deathRate_", deathRate, ".mutationRate1_", mutationRate1, ".mutationRate2_", mutationRate2, ".mutationRateRB_", mutationRateB, ".treatmentIntensity_", treatmentIntensity, ".drugInducedDeathRate1_", drugInducedDeathRate1, ".drugInducedDeathRate2_", drugInducedDeathRate2, ".dateTime_", Sys.time(), ".csv", sep = ""), row.names=FALSE)

```


# DRUG-INDUCED DEATH RATE SHOULDNT BE ARBITRARY

CYCLIC TREATMENT MODEL
```{r}
# Event Rates
